    ...
    <div class="col-md-12">
            ...
            <thead>
                <tr>
                    ...
                    <th style="width: 400px; vertical-align: middle; text-align: left; word-wrap: break-word;">
                        ...
                        <p style="margin-top: -6px; line-height: 16px;"><span style="font-size: 12px; font-weight: normal;">{!! $company_information->full_address !!}</span></p>
                    ...
                    <th style="vertical-align: middle; text-align: right;">
                        ...
                        @if(!empty($company_information->gst_no))<p style="line-height: 0px;"><span style="font-size: 12px; font-weight: 600;">GSTN:</span> <span style="font-size: 12px; font-weight: normal;">{{ $company_information->gst_no }}</span></p>@endif
                    </th>
                </tr>
                <tr>
                    <th colspan="3"><hr/></th>
        ...
        <table class="print-table" style="width: 100%; border-collapse: collapse; margin-top: 60px;">
            <tr>
                ...
                <th style="padding: 8px; border: 1px solid #ddd; vertical-align: middle; text-align: left;"><label style="font-size: 12px;">CATEGORY</label></th>
                ...
                @foreach($data->saleProducts as $v)
                    @if(!empty($v->productInfo) && !empty($v->unitInfo))
                        <tr>
                            ...
                            <td style="padding: 8px; border: 1px solid #ddd; vertical-align: middle; text-align: left; font-size: 12px;">{{ $v->productInfo->baseProduct->name }}</td>
            ...
            @else
                <tr>
                    <td colspan="12" style="padding: 8px; border: 1px solid #ddd; vertical-align: middle; text-align: left; font-size: 12px;">No records found!</td>
                </tr>
            @endif
            <tr>
                <th colspan="11" style="padding: 8px; border: 1px solid #ddd; vertical-align: middle; text-align: right; font-size: 12px;"><label>Total Amount</label></th>
            ...
            <tr>
                <th colspan="11" style="padding: 8px; border: 1px solid #ddd; vertical-align: middle; text-align: right; font-size: 12px;"><label>Discount</label></th>
            ...
            <tr>
                <th colspan="11" style="padding: 8px; border: 1px solid #ddd; vertical-align: middle; text-align: right; font-size: 12px;"><label>Total Payable Amount</label></th>
            ...
            <tr>
                <td colspan="12" style="padding: 8px; border: 1px solid #ddd; vertical-align: middle; text-align: left; font-size: 13px;">
